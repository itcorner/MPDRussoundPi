...
connector="${RUSSOUND_SER2NET_CONNECTOR:-serialdev,${device},${RUSSOUND_SERIAL_OPTIONS:-19200n81},local}"
...
%YAML 1.1
---
connection: &russound {accepter: "tcp,${RUSSOUND_SER2NET_BIND:-0.0.0.0},${RUSSOUND_SER2NET_PORT:-6666}", enable: on, options: {telnet-brk-on-sync: true, mdns: false, connector-retry-time: 5}, connector: "${connector}"}
EOF
