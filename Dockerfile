...
# Web application only. The serial gateway lives in Dockerfile.ser2net and the
# hardware-free backend in Dockerfile.dummy.
...
ENV RUSSOUND_WEB_HOST=0.0.0.0 \
    ...
    RUSSOUND_BACKEND_HOST=russound-ser2net \
